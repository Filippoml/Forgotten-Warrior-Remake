namespace GXPEngine
{
    ...
    /// <summary>
    /// Defines the MouseEventType
    /// </summary>
    public enum MouseEventType
    {
        /// <summary>
        /// Defines the MouseDown
        /// </summary>
        MouseDown,

        /// <summary>
        /// Defines the MouseDownOnTarget
        /// </summary>
        MouseDownOnTarget,
        ...
        /// <summary>
        /// Defines the MouseMoveOnTarget
        /// </summary>
        MouseMoveOnTarget,

        /// <summary>
        /// Defines the MouseOverTarget
        /// </summary>
        MouseOverTarget,

        /// <summary>
        /// Defines the MouseOffTarget
        /// </summary>
        MouseOffTarget,

        /// <summary>
        /// Defines the MouseClick
        /// </summary>
        MouseClick
    }
}
