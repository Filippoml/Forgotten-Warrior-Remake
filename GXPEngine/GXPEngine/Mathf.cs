namespace GXPEngine
{
    ...
    public static class Mathf
    {
        ...
        /// </summary>
        /// <param name="f">The f<see cref="float"/></param>
        /// <returns>The <see cref="float"/></returns>
        ...
        /// </summary>
        /// <param name="value1">The value1<see cref="float"/></param>
        /// <param name="value2">The value2<see cref="float"/></param>
        /// <returns>The <see cref="float"/></returns>
        ...
        /// Returns the biggest of the two specified values
        /// </summary>
        /// <param name="value1">The value1<see cref="int"/></param>
        /// <param name="value2">The value2<see cref="int"/></param>
        /// <returns>The <see cref="int"/></returns>
